...
| `budgetScope` | object | — | Scope segments for targeting a specific budget (e.g. `{ "workspace": "road", "app": "lane" }`). Values are case-insensitive — the Cycles server lowercases all scope identifiers. |
