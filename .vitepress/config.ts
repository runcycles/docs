    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Idempotency, Retries and Concurrency', link: '/idempotency-retries-and-concurrency-why-cycles-is-built-for-real-failure-modes' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Caps and Three-Way Decisions', link: '/caps-and-the-three-way-decision-model-in-cycles' },
          { text: 'Commit Overage Policies', link: '/commit-overage-policies-in-cycles-reject-allow-if-available-and-allow-with-overdraft' },
          { text: 'TTL, Grace Period, and Extend', link: '/reservation-ttl-grace-period-and-extend-in-cycles' },
          { text: 'Decide: Preflight Checks', link: '/how-decide-works-in-cycles-preflight-budget-checks-without-reservation' },
          { text: 'Dry Run and Shadow Mode', link: '/dry-run-shadow-mode-evaluation-in-cycles' },
          { text: 'Events and Direct Debit', link: '/how-events-work-in-cycles-direct-debit-without-reservation' },
          { text: 'Debt and Overdraft', link: '/debt-overdraft-and-the-over-limit-model-in-cycles' },
      ...
      },
      {
        ...
        items: [
          { text: 'Runaway Agents and Tool Loops', link: '/runaway-agents-tool-loops-and-budget-overruns-the-incidents-cycles-is-designed-to-prevent' },
        ]
      }
    ],
    socialLinks: [
