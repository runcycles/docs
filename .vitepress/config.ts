    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Authentication & Tenancy', link: '/authentication-tenancy-and-api-keys-in-cycles' },
          ...
          { text: 'Dry Run (Shadow Mode)', link: '/dry-run-shadow-mode-evaluation-in-cycles' },
          ...
          { text: 'Reservation Recovery & Listing', link: '/reservation-recovery-and-listing-in-cycles' },
          { text: 'Metrics & Metadata', link: '/standard-metrics-and-metadata-in-cycles' },
