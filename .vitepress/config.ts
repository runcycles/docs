...
export default defineConfig({
  ...
  description: 'Stop runaway spend and risky agent actions before they execute. Open protocol, multi-language SDKs, Apache 2.0.',
  cleanUrls: true,
  lang: 'en',
  ...
  head: [
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      "description": "Runtime authority for autonomous agents. Stop runaway spend and risky agent actions before they execute.",
  ...
  transformPageData(pageData) {
    ...
    const defaultDescription = 'Stop runaway spend and risky agent actions before they execute. Open protocol, multi-language SDKs, Apache 2.0.'
