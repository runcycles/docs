...
export default defineConfig({
  ...
  cleanUrls: true,
  lang: 'en',
  titleTemplate: ':title — Runtime authority for autonomous execution',
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Cycles — Runtime authority for autonomous execution' }],
    ...
    ['meta', { name: 'twitter:title', content: 'Cycles — Runtime authority for autonomous execution' }],
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      "description": "Runtime authority for autonomous execution. Keep agents within approved spend, risk, and action limits.",
